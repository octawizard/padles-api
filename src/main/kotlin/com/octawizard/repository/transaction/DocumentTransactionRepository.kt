    ...
    override fun createReservation(
        ...
        val txnBody: TransactionBody<Reservation> = TransactionBody {
            ...
            val updateResult = clubs.updateOneById(
                clientSession,
                clubReservationInfo.clubId,
                pullByFilter(
                    and(listOf(
                        availableFieldTimeSlotProperty / TimeSlot::startDateTime eq startTime,
                        availableFieldTimeSlotProperty / TimeSlot::endDateTime eq endTime,
                        availableFieldIdProperty eq clubReservationInfo.field.id
                    ))
                )
            )
